...
export default function Sucursales() {
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-slate-800 fade-in-down">
        Nuestras Farmacia
      </h2>
      <div className="flex flex-col sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-3 lg:grid-rows-3 h-full lg:gap-y-80 lg:gap-x-32 pt-10 lg:py-10 overflow-scroll lg:overflow-hidden fade-in-up">
